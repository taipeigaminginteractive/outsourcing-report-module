...
- 請依據參考資料，完成對應程式碼與相關測項  
- 在本地端通過相關測項  

## Outsourcing Rules

This repository is only used for task-based outsourcing.

- This is NOT a team collaboration repo
- No real-time communication is provided
- This repository does NOT reflect internal architecture or production systems

此 Repository 只用於進行獨立任務的外包工作

- 本 Repository **不是** 團隊協作空間
- **不會** 提供即時溝通或討論機制
...
All deliverables submitted to this repository are considered **work-for-hire**  
and are fully owned by the project owner.

所有提交至本 Repository 的內容， 均視為 **委外成果（Work-for-hire）**，  
其著作財產權完全歸屬於專案擁有者。

詳細法律條款請參閱 [`NOTICE.md`](./NOTICE.md)。
